const PopularNotes = ({ jmluser, title }) => {
    return (
        <div className="flex flex-col rounded-xl items-start w-[300px] h-[278px] p-6 gap-5 border border-gray-500 hover:border-[#FFB400]" data-aos="fade-up" data-aos-duration="1000">
