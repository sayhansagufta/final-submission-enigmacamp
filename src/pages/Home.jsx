    ...
    return (
      <>
        <section className="hero flex flex-col items-center pb-14">
          <h1 className="text-center font-extrabold text-5xl  pb-5">
          ...
          <p className="font-light text-center text-xl text-gray-500 leading-none pb-5">
          ...
          <button className='w-fit content-center flex flex-row items-center gap-3 rounded-full mt-6 pl-4 pr-1 py-1 bg-white border border-[#5647F9] hover:bg-[#5647F9] hover:text-white'>
            <p>Daftar Sekarang</p>
            <img className='bg-[#5647F9] rounded-full p-1 -rotate-45' src="src/assets/arrow.svg" alt="daftar" />
          </button>
        </section>
            ...
            <div className="cards flex flex-row gap-6 max-w-6xl mx-auto">
              <div className="flex flex-col rounded-xl items-start w-[210px] h-[278px] p-6 gap-5 border border-gray-500 hover:border-[#FFB400]"> 
                <div className="flex justify-center items-center rounded-xl w-40 h-40 p-4 bg-[#5647F9]">
                  <img className="h-40" src="src/assets/arrow.svg" alt="" />
                </div>
                <div>
