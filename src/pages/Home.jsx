    ...
    <>
      <section className="hero flex flex-col items-center pb-14">
        ...
        <Button
          ...
          endContent={
            <img
              className="bg-[#5647F9] size-7 p-1 -me-2  rounded-full -rotate-45 group-hover:rotate-0 transition-all duration-500"
      ...
      <section className="kategori bg-white">
        <div className="flex flex-row justify-between items-center max-w-6xl mx-auto py-16">
          ...
          <button className="rounded-full font-semibold border py-2 px-4 border-gray-500 w-fit hover:bg-[#5647F9] hover:text-white">
            Lihat Semua
          </button>
        </div>
